...
function About() {
    return (
        ...
        <div className="bg-amber-600">
            <div
                className="bg-amber-600 p-8 md:p-12 lg:p-16 text-white text-center  pb-2">
                ...
                <p className="md:px-32 pt-3 text-base md:text-lg lg:text-xl font-mono leading-loose text-slate-50">
                    Since writing my first line of code in 2019, I have committed myself to a life of learning and
                    growth in
                    the world of tech.
                    In that time, I have worked on a large variety of projects, ranging from simple games to working
                    with
